...
<div class="container mb-2 mb-md-5">
    <div class="row mb-4 step-apply">
        <div class="col-3">
            <a class="text-xs-left btn btn-block {{ $step == 1 ? 'btn-success':'btn-primary' }}" href="{{ route('apply.visa.step1') }}"><span class="step-number d-sm-none"><i class="fa fa-info fa-fw"></i>Step 1</span><span class="step-desk d-none d-sm-block">1.Informations</span></a></div>
